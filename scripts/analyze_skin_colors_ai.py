...
# v10: TypeScript COLOR_TAGS ile 1:1 hizalı — 12 renk + 8 stil
...
Valid colors: red,blue,green,purple,gold,black,white,orange,pink,yellow,brown,gray
Valid styles: cyberpunk,neon,vintage,military,premium,doppler-family,tactical,futuristic,null

Rules:
- Up to 3 dominant colors (>15% of skin pattern), MOST DOMINANT FIRST
- The first color MUST be the visually most dominant one (largest area or most striking)
- Ignore wooden stock/grip colors on rifles (AK-47, AWP wood, etc.)
- Include accent colors even if small (e.g. Redline = red+black)
- Doppler/Fade/Marble Fade skins use style="doppler-family"
- Brown for dark wood/leather tones, gray for metallic/concrete tones, yellow for vivid yellow
